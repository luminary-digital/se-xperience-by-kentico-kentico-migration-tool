...
public class WidgetGeneralSelectorMigration(ILogger<WidgetPageSelectorMigration> logger, ISpoiledGuidContext spoiledGuidContext) : IWidgetPropertyMigration
{
